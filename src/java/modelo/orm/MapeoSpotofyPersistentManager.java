...
public class MapeoSpotofyPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "MapeoSpotofy";
	...
	private MapeoSpotofyPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new MapeoSpotofyPersistentManager();
		}
